/*
 * Generic MII/PHY management.  Portable bit-twiddling over a driver-supplied
 * mir/miw register pair (no MMIO of its own), vendored from os/port into the
 * native os/drivers pool so PCI NICs that drive an external PHY (igbe, ...)
 * can link it.  Dropped the os/pc "io.h" include — nothing here is x86.
 */
#include "u.h"
#include "../port/lib.h"
#include "mem.h"
