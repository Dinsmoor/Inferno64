...
/*
 * This structure must agree with FPsave and FPrestore in emu/Linux/asm-aarch64.S
 * FPsave/FPrestore save all 32 double-precision (64-bit) FP registers: 32 * 8 = 256 bytes
 */
